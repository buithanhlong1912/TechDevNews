            ...
            <div className="container ">
                {listTop4 &&
                    <div className="w-75 py-5 px-5 ">
                        <p style={{cursor:"pointer"}} onClick={()=>handleDetailComponent(listTop4[0].id)} className="h1">{listTop4[0].title} </p>
                ...
                {listTop4 &&
                    <div className="row px-5 py-4 borderCom1 rounded-top">
                        <div className="col-12 col-md-4 px-4">
                            <p style={{cursor:"pointer"}} onClick={()=>handleDetailComponent(listTop4[1].id)} className="h5">{listTop4[1].title} </p>
                        ...
                        <div className="col-12 col-md-4 px-4">
                            <p style={{cursor:"pointer"}} onClick={()=>handleDetailComponent(listTop4[2].id)} className="h5">{listTop4[2].title} </p>
                        ...
                        <div className="col-12 col-md-4 px-4">
                            <p style={{cursor:"pointer"}} onClick={()=>handleDetailComponent(listTop4[3].id)} className="h5">{listTop4[3].title} </p>
